...
First of all I loaded the latest Citrus [release archive](${site.path}/docs/download) to an empty folder on my local storage. Unzip the archive in order 
...
(citrus-core.jar, citrus-http.jar, etc.) coming from the downladed [release archive](${site.path}/docs/download) and all dependency libraries also 
