...
The complete source code for all tests shown in this post is available in the [EIP with Camel](https://github.com/christophd/eip-with-camel/tree/chore/citrus-testing) repository. The [Routing Fundamentals example](https://github.com/christophd/eip-with-camel/tree/chore/citrus-testing/examples/09-routing-fundamentals) includes:

- **Quarkus tests:** [EipTests.java](https://github.com/christophd/eip-with-camel/blob/chore/citrus-testing/examples/09-routing-fundamentals/quarkus/src/test/java/com/example/eip/routing/EipTests.java) with Content-Based Router, Message Filter, Recipient List, and Splitter tests.
- **Spring Boot tests:** [EipTests.java](https://github.com/christophd/eip-with-camel/blob/chore/citrus-testing/examples/09-routing-fundamentals/spring-boot/src/test/java/com/example/eip/routing/EipTests.java) with Content-Based Router, Message Filter, Recipient List, and Splitter tests.
- **Route definitions:** [ContentBasedRouterRoute.java](https://github.com/christophd/eip-with-camel/blob/chore/citrus-testing/examples/09-routing-fundamentals/quarkus/src/main/java/com/example/eip/routing/ContentBasedRouterRoute.java), [MessageFilterRoute.java](https://github.com/christophd/eip-with-camel/blob/chore/citrus-testing/examples/09-routing-fundamentals/quarkus/src/main/java/com/example/eip/routing/MessageFilterRoute.java), [SplitterRoute.java](https://github.com/christophd/eip-with-camel/blob/chore/citrus-testing/examples/09-routing-fundamentals/quarkus/src/main/java/com/example/eip/routing/SplitterRoute.java).
- **YAML DSL tests:** [content-based-router.citrus.it.yaml](https://github.com/christophd/eip-with-camel/blob/chore/citrus-testing/examples/09-routing-fundamentals/yaml-dsl/test/content-based-router.citrus.it.yaml), [message-filter.citrus.it.yaml](https://github.com/christophd/eip-with-camel/blob/chore/citrus-testing/examples/09-routing-fundamentals/yaml-dsl/test/message-filter.citrus.it.yaml), [splitter.citrus.it.yaml](https://github.com/christophd/eip-with-camel/blob/chore/citrus-testing/examples/09-routing-fundamentals/yaml-dsl/test/splitter.citrus.it.yaml).
- **Message templates:** [order.json](https://github.com/christophd/eip-with-camel/blob/chore/citrus-testing/examples/09-routing-fundamentals/quarkus/src/test/resources/templates/order.json), [batch-order.json](https://github.com/christophd/eip-with-camel/blob/chore/citrus-testing/examples/09-routing-fundamentals/quarkus/src/test/resources/templates/batch-order.json), [item.json](https://github.com/christophd/eip-with-camel/blob/chore/citrus-testing/examples/09-routing-fundamentals/quarkus/src/test/resources/templates/item.json).
