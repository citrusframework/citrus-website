...
![project-dashboard.png](/img/citrus-admin/project-dashboard.png)
...
![config-endpoints.png](/img/citrus-admin/config-endpoints.png)
...
![test-list.png](/img/citrus-admin/test-list.png)
...
![test-info.png](/img/citrus-admin/test-info.png)
![test-sources.png](/img/citrus-admin/test-sources.png)
...
![test-execute.png](/img/citrus-admin/test-execute.png)
...
![test-messages.png](/img/citrus-admin/test-messages.png)
...
![test-report.png](/img/citrus-admin/test-report.png)

When a test case is failing for some reason exception and failure information will be provided.

![test-results.png](/img/citrus-admin/test-results.png)
