---
layout: post
title: YAY, Citrus 3.0.0 is here!
short-title: Citrus 3.0.0
author: Christoph Deppisch
github: christophd
categories: [blog]
---

YAY, Citrus 3.0.0 is here! A few weeks ago we have released a new major release for the Citrus integration testing framework! 
...
3.0.0 has been a tremendous challenge. Citrus is back and stronger than ever before! 

This summary is here to share our strategy, ideas and all major changes that are part of Citrus 3.0.0!

# Objectives

Citrus 3.0.0 is a major release, and we want to take that as an opportunity to follow up with some improvements and refactoring that we are eager to do for quite some time. 
...
- [Core modules](https://github.com/citrusframework/citrus/tree/main/core)
...
- [Runtime modules](https://github.com/citrusframework/citrus/tree/main/runtime)
...
- [Endpoint modules](https://github.com/citrusframework/citrus/tree/main/endpoints)
...
- [Validation modules](https://github.com/citrusframework/citrus/tree/main/validation)
...
- [Connector modules](https://github.com/citrusframework/citrus/tree/main/connectors)
...
- [Tools](https://github.com/citrusframework/citrus/tree/main/tools)
...
- [Catalog modules](https://github.com/citrusframework/citrus/tree/main/catalog)
...
- [Vintage modules](https://github.com/citrusframework/citrus/tree/main/vintage)
...
- [Utility modules](https://github.com/citrusframework/citrus/tree/main/utils)
...
So 3.0.0 is the first version of the Citrus 3.x release train. And we are not done yet! 
...
We love to get feedback so please give it a try and tell us what you think about Citrus 3.0.0. 
