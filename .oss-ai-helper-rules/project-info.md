...
- **Remote pattern:** `citrusframework/citrus-website`
- **GitHub repo:** `citrusframework/citrus-website`
- **Issue tracker:** GitHub
- **Issue tracker URL:** `https://github.com/citrusframework/citrus-website/issues`
